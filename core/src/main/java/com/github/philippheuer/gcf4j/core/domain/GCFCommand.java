...
import com.github.philippheuer.gcf4j.core.command.GCFCommandContext;
...
@AllArgsConstructor
@Getter
public class GCFCommand implements IGCFCommand {
     ...
     */
    public void onSuperExecution(IGCFMessageContext ctx) {
        ...
        // call onExecution
        getOnExecution().accept(commandContext);
    }
